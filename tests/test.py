...
total_semesters = int(input("Enter your total semester number: "))
effective_year = input("Enter your effective year: ")
...
wb.save(f"{classname}_{department}_{effective_year}_Curriculum.xlsx")